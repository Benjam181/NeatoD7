...
static void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOA, LD2_Pin|M2_DIR_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : LD2_Pin M2_DIR_Pin */
  GPIO_InitStruct.Pin = LD2_Pin|M2_DIR_Pin;
...
void HAL_TIM_IC_CaptureCallback(TIM_HandleTypeDef *htim)
{
    if(htim->Channel == HAL_TIM_ACTIVE_CHANNEL_1)
    {
        pulse_count++;
        printf("Pulses: %ld\r\n", pulse_count);
        // delta = __HAL_TIM_GET_COMPARE(htim, TIM_CHANNEL_1);
    }
}
